...
parser = argparse.ArgumentParser(
    description="ANTLR MNIST/N-MNIST Arguments", fromfile_prefix_chars="@"
)
...
model_args.add_argument(
    "--grad-clip", type=float, default=1.0, metavar="F", help="(default: 1.0)"
)
...
def main():
    ...
    if config.task == "mnist":
        ...
        data_loaders = nmnist_dataset.load_loader(
            config=config,
            num_workers=config.num_workers,
            batch_size=config.batch_size,
            test_batch_size=config.test_batch_size,
